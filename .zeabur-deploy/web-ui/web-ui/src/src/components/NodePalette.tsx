...
const nodeItems: NodeItem[] = [
  ...
  { type: 'code', label: 'Code', icon: <Code size={16} />, color: '#FF9800' },
  { type: 'if', label: 'If Condition', icon: <GitBranch size={16} />, color: '#E91E63' },
  { type: 'for', label: 'For Loop', icon: <RefreshCw size={16} />, color: '#9C27B0' },
  ...
  { type: 'slack', label: 'Slack', icon: <MessageSquare size={16} />, color: '#4A154B' },
  { type: 'telegram', label: 'Telegram', icon: <Send size={16} />, color: '#0088CC' },
  { type: 'sheets', label: 'Google Sheets', icon: <Table size={16} />, color: '#0F9D58' },
  { type: 'github', label: 'GitHub', icon: <Github size={16} />, color: '#24292E' },
  { type: 'notion', label: 'Notion', icon: <FileBox size={16} />, color: '#000000' },
]
